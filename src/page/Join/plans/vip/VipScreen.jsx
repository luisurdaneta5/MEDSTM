...
export const VipScreen = () => {
	...
	useEffect(() => {
		const plans = async () => {
			const response = await Api.get("/plans/vips");
			setPlans(response.data.plans);
			setVips(response.data.vips);
		};
		plans();
	}, []);
											...
											>
												...
												<AccordionDetails>
													...
													>
														...
														{user ===
														"professional-healthcare"
															? vip.percentage_professional
															: vip.percentage_promotor}
														% de la membresía de
														cada Invitado
														Premium/VIP (esto
